...
const NotTech = ({ data }: { data: NotTechQuery }) => {
    return (
        <Layout seo={seo}>
            ...
            <h2>Art</h2>
            <p>I like trying new forms of art as something to unwind. I have tried subscribing to the art box <a href="https://artful.co.uk" target="_blank" rel="noopener noreferrer">Artful</a> which is great – boxes include lino printing and india ink. I have been trying out pottery courses at <a href="https://claytime.london" target="_blank" rel="noopener noreferrer">Claytime</a> as well.</p>
